    ...
    static final Object[][] contents=
            {
                    ...
                    {"textarea_greeting_test","1. Введите фамилию и название группы"+"\n"+
                            "2. Нажмите кнопку \"Выбрать тест\""+"\n"+
                            "3. Выберите нужный файл теста"+"\n"+
                            "4. Выберите нужный вариант ответа"+"\n"+
                            "5. При помощи кнопок \"< Назад\" и \"Далее >\""+"\n"+
                            "    заполните предлагаемый тест"+"\n"+
                            "6. Вывод результатов - кнопка \"Результат\""},
